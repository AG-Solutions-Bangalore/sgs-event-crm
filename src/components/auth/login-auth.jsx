...
export default function AuthUI() {
    ...
    try {
      ...
      if (res?.code === 200) {
        ...
        if (companyData) {
          ...
          dispatch(setCompanyImage(res?.company_image || []));
        }
      } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-600 via-orange-500 to-orange-600 flex items-center justify-center p-4 overflow-hidden relative">
      <BackgroundSVG />
      <motion.div
