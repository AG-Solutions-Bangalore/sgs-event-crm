    ...
    >
      <div className="flex items-center rounded-md mb-4 md:mb-6">
        {logoUrl ? (
          ...
          <div className="h-12 w-12 bg-primary/10 rounded-lg flex items-center justify-center text-primary font-bold text-center text-[10px] leading-tight px-1 text-wrap">
             {companyDetails?.store_name || "SGS Event CRM"}
          </div>
        )}
      </div>
